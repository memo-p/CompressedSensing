...
{   
    ...
    for (i=0; i<length; ++i){
        ...
        minS[r1[i].byte[depth]] = (minS[r1[i].byte[depth]] < r1[i].val)? minS[r1[i].byte[depth]] : r1[i].val;
        maxS[r1[i].byte[depth]] = (maxS[r1[i].byte[depth]] > r1[i].val)? maxS[r1[i].byte[depth]] : r1[i].val;
    }
